    ...
    <div class="container">
        <form id="reg" action="/PHPfuncs/action.php" method="post">
            <div class="form-group row">
                <label class="col-sm-5 col-lg-3 col-form-label">Имя <font style="color:red">*</font></label>
            ...
            <div id="emailblock" class="form-group row">
                <label for="inputHorizontalSuccess" class="col-sm-5 col-lg-3 col-form-label ">Email <font style="color:red">*</font></label>
                <div class="col-sm-7 col-lg-8">
            ...
            <div id="passblock" class="form-group row">
                <label for="inputHorizontalSuccess" class="col-sm-5 col-lg-3 col-form-label">Пароль <font style="color:red">*</font></label>
                <div class="col-sm-7 col-lg-8">
            ...
            <div id="pass_againblock" class="form-group row">
                <label for="inputHorizontalSuccess" class="col-sm-5 col-lg-3 col-form-label">Еще раз <font style="color:red">*</font></label>
                <div class="col-sm-7 col-lg-8">
            ...
            <div id="address_block" class="form-group row">
                <label class="col-sm-5 col-lg-3 col-form-label">Адрес <font style="color:red">*</font></label>
                <div class="col-sm-7 col-lg-8">
                    <input required type="text" id="address" name="address" class="form-control" >
                </div>
            </div>
            <div class="form-group row">
                <label for="inputHorizontalSuccess" class="col-sm-5 col-lg-3 col-form-label">Телефон <font style="color:red">*</font></label>
                <div class="col-sm-7 col-lg-8">
